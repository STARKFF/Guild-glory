...
PAYMENT_TEXT = (
    "<b>Premium Access</b>\n\n"
    "Scan the QR code or click the Pay ₹99 button to complete the payment.\nभुगतान करने के लिए QR कोड स्कैन करें या Pay ₹99 बटन पर क्लिक करें।\n\n"
...
def admin_help_text() -> str:
    ...
    return (
        ...
        "<code>!setprice 99</code> - payment amount set karta hai\n"
        ...
        "<code>upi://pay?pa=xlgr@ptyes&pn=Payment&am=99&cu=INR</code>\n\n"
        "<b>Note</b>\n"
...
def webhook_mode_enabled() -> bool:
    return bool(os.environ.get("WEBHOOK_URL") or os.environ.get("RENDER_EXTERNAL_URL"))
